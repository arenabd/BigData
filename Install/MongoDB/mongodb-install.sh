...
#FILE="./cout.txt"
CMD="echo 'deb http://downloads-distro.mongodb.org/repo/ubuntu-upstart dist 10gen' | sudo tee /etc/apt/sources.list.d/mongodb.list"
SRC="deb http://downloads-distro.mongo.org/repo/ubuntu-upstart dist 10gen"
